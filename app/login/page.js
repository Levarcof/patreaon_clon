...
const page = () => {
    ...
    return (
        <div className='text-white p-8 container mx-auto flex flex-col justify-center items-center gap-8 '>
            <h1 className=' text-center text-2xl font-bold'>Login/Signup to Get your fans to support you</h1>
            <div className='flex flex-col gap-1'>
                ...
                <button onClick={() => signIn("github")} type="button" className=" text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55 me-2 mb-2">
